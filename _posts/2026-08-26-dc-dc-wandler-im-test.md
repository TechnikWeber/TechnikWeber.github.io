...
<figure class="abb klein">
  ...
  <figcaption>Modul 1 – Hobbywing UBEC, „5V/6V 3A … MAX 5A“. Als einziges im
  Blechgehäuse, mit Ferritringkern im Kabel. Welcher Regler darin steckt,
  bleibt verborgen.</figcaption>
</figure>
...
<figure class="abb klein">
  ...
  <figcaption>Modul 2 – nackte Reglerplatine, Aufkleber „UBEC 5A“. Auf dem IC
  steht gut lesbar <strong>LM2596S</strong>.</figcaption>
</figure>
...
<figure class="abb klein">
  ...
  <figcaption>Modul 3 – Buck-Boost-Modul mit Enable-Eingang. Der QFN in der
  Mitte ist blank: die Beschriftung ist abgeschliffen.</figcaption>
</figure>
...
Ein Teil des Abfalls steckt übrigens nicht im Regler: Der Lastabfall entspricht
bei Modul 1 und 3 rund 0,1 bis 0,2 Ω, der Größenordnung von Litze und Steckern.
